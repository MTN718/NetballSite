      ...
      <div class="container"> 
        ...
        <div class="left-side"> 
          ...
          <div id="logo"> <a href="<?php echo site_url('netball/index');?>">
            <img src="<?php echo base_url('assets/images/logoinspire.jpg');?>" alt=""></a> </div>
...
<div class="sign-in-form style-1">
  ...
  <div class="tabs-container alt"> 
      ...
      <span class="lost_password"> <a href="<?php echo site_url('netball/resetNewPassword');?>" >Lost Your Password?</a> </span> </p>
      <div class="form-row">
