...
================================================== -->
  ...
  <section class="fullwidth padding-top-75 padding-bottom-70" data-background-color="#f8f8f8">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="headline centered margin-bottom-45"> Most Visited Events <span>Discover top-rated local businesses</span> </h3>
        </div>
        <div class="col-md-12">
  ...
  <!-- Flip banner -->
  <a href="#" class="flip-banner parallax margin-top-65" data-background="<?php echo base_url('assets/images/slider-bg-02.jpg');?>" data-color="#f2642a" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666">
  <div class="flip-banner-content">
    <h2 class="flip-visible">Inspire Sports Group</h2>
