 <div class="dashboard-content">
    ...
    <div id="titlebar">
        <div class="row">
            <div class="col-md-12">
                <h2>Inspire Sports Group :: Add Faqs </h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="#">Home</a></li>
            ...
            <div id="add-listing">
                ...
                <div class="add-listing-section">
                    ...
                    <div class="add-listing-headline">
                        <h3><i class="sl sl-icon-plus"></i> Add Faqs 
                    ...
                    <div class="submit-section">
                        <form method="post" action="<?php echo site_url();?>/admin/addfaqsdata">
                            <div class="row with-forms">
                               ...
                               <div class="col-md-12">
                                  <h5> Answer </h5>
                                  <textarea type="text" id="WYSIHTML2" class="form-control" name="answer" placeholder="Answer" required="required"></textarea>
                              </div>
